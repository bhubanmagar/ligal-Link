...
export const CapmaignSection = () => {
  return (
    <>
      <div className="relative bg-[#2F2D9B] text-white py-16 px-4 h-screen">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mt-8">
            ...
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-lg font-semibold mt-4">Campaign Building</h3>
              <p className="text-sm mt-2 text-blue-200">
                Lorem ipsum dolor sit amet, etur ing elit, sed do eiusmod
                tempor.
              </p>
            ...
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-lg font-semibold mt-4">Sponsored Content</h3>
              <p className="text-sm mt-2 text-blue-200">
                Lorem ipsum dolor sit amet, etur ing elit, sed do eiusmod
                tempor.
              </p>
          ...
          <div className="absolute w-1/2 right-0 top-110">
            <div className="relative"></div>
            <button className="mt-8 px-6 py-2 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-700 transition">
              More About Us ➔
            </button>
            <img
              src={square}
              alt="square pattern"
              className="absolute w-20 h-20 top-21 left-0"
            />
          </div>
        </div>
      </div>
